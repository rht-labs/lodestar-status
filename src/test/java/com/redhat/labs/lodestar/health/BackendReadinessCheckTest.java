...
public class BackendReadinessCheckTest {
    ...
    void testBackendReadinessCheckUp() {
        ...
        // given
        Mockito.when(client.getBackendStatus()).thenReturn(HealthStatus.builder().status("UP").build());
    ...
    void testBackendReadinessCheckDown() {
        ...
        // given
        Mockito.when(client.getBackendStatus()).thenReturn(HealthStatus.builder().status("DOWN").build());
